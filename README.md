...
It provides an interface for utilizing the various [d3 interpolaters](https://github.com/d3/d3-interpolate) to make state transitions.  All the examples are SVG and the library focused on data visualization, but in the future this library could be used to transition any component state really.
