...
If you go to the [docs site](https://sghall.github.io/resonance/#/documentation/node-group), this code is running and the results are being logged to the console.
